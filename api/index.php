...
try {
  switch ($path) {
    ...
    case 'ticket.create': {
      ...
      // Optimistic retry logic for handling duplicate ticket_no collisions
      $maxRetries = 4;
      $ticketNo = null;
      $tid = null;
      ...
      for($attempt = 0; $attempt < $maxRetries; $attempt++){
        try {
          // Recompute ticket number on each attempt
          ...
          // Not a duplicate error or retries exhausted, rethrow
          throw $e;
        }
      }
