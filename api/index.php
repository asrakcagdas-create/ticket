...
try {
  switch ($path) {
    ...
    case 'ticket.create': {
      ...
      // Optimistic retry logic for duplicate ticket_no (up to 4 retries)
      $maxRetries = 4;
      $ticketNo = null;
      $tid = null;
      
      for($attempt = 0; $attempt <= $maxRetries; $attempt++){
        // Get the last ticket number and compute next
        ...
        try {
          ...
          // If not duplicate or retries exhausted, rethrow
          throw $e;
        }
      }
